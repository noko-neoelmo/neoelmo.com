        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl mb-8">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">土屋沙也加</h3>
                <p className="text-gray-600 dark:text-gray-300 text-lg">代表取締役</p>
              </div>
            ...
            <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
              <h4 className="font-bold text-lg mb-4 text-gray-900 dark:text-white">経歴</h4>
