        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="relative w-80 h-80 mx-auto">
              {/* Design Circle - Top */}
              <motion.div
                className="absolute w-48 h-48 rounded-full border-4 border-black bg-white dark:border-white dark:bg-black flex items-center justify-center"
              ...
              >
                <div className="text-center">
                  <h3 className="text-xl font-bold mb-2 text-black dark:text-white">Design</h3>
                  <p className="text-sm text-black dark:text-white">強くしなやかな<br />事業設計</p>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center">
                  <h3 className="text-xl font-bold mb-2 text-black dark:text-white">Narrative</h3>
                  <p className="text-sm text-black dark:text-white">コミュニティに<br />支持される<br />マーケティング</p>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center">
                  <h3 className="text-xl font-bold mb-2 text-black dark:text-white">AI</h3>
                  <p className="text-sm text-black dark:text-white">成果を生み出す<br />AI活用</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
